...
This repository contains source code of our paper

[DecIF: Improving Instruction-Following through Meta-Decomposition](https://arxiv.org/abs/2505.13990#:~:text=In%20this%20paper%2C%20we%20introduce%20DecIF%2C%20a%20fully,diverse%20and%20high-quality%20instruction-following%20data%20using%20only%20LLMs.)

## Training Data
We release our 10k and 30k instruction-following data generated by LLaMA-3.1-70B-Instruct on ModelScope. You can directly download the data and training your own models or mix with other domains data.

[DecIF Dataset](https://www.modelscope.cn/datasets/Hyphens/DecIF-10K-and-30K/summary)
